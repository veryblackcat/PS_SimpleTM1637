...
protected:
	...
	// inline
	void clkLOW()  {pinMode(clk, OUTPUT);} // #define TM1637_CLK_LOW     pinMode(clk, OUTPUT)
	void clkHIGH() {pinMode(clk, INPUT); } // #define TM1637_CLK_HIGH    pinMode(clk, INPUT)
	void dioLOW()  {pinMode(dio, OUTPUT);} // #define TM1637_DIO_LOW     pinMode(dio, OUTPUT)
	void dioHIGH() {pinMode(dio, INPUT); } // #define TM1637_DIO_HIGH    pinMode(dio, INPUT)
	void clkWaiting() {delayMicroseconds(delayBUS);} // #define TM1637_CLK_WAITING delayMicroseconds(delayBUS)
